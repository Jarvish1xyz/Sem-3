...
--11. Display name of customers with branch whose amount is greater than 4000 and account no is less 105 from deposit table.
SELECT CNAME, BNAME
FROM DEPOSIT
...
SELECT *
FROM BORROW
WHERE (AMOUNT>1000 AND AMOUNT<=7000) AND (LOANNO NOT BETWEEN 250 AND 600);
...
SELECT *
FROM DEPOSIT
WHERE AMOUNT>2000 AND (ACTNO BETWEEN 100 AND 110);
