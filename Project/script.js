...
function displayCard() {
    ...
    studentsA.forEach((student, index) => {
        studentCard.className = "student-card stucard";
        studentCard.innerHTML = `
            <div class="card">
                <h5 class="card-header">${student.name}</h5>
                <div class="card-body">
                    <h5 class="card-title">Roll No: ${student.roll}</h5>
                    <p class="card-text">Enrollment No: ${student.enroll}</p>
                    <a href="#" class="btn btn-primary">Go somewhere</a>
                </div>
            </div>
        `;
        document.getElementById("studentCard").appendChild(studentCard);
    });
}
